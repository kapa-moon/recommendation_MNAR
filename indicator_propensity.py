...
def get_logis_propensity():
    if dataset_name == "coat":
        train_mat, test_mat = load_data("coat")# train_mat is the original rating matrix
    ...
    for epoch in range(7):
        ...
        # print(y_pred)
        # print(y_train)
        # loss_regularization2 = 0
        loss_regularization2 = sum(1/y_pred)/87000/2
        # loss_regularization2 = (0.01*sum(1/(y_pred)**2))/87000
        # print(loss_regularization2)
        # UI = torch.tensor(UI)
